  ...
  <div class = "visrow height-fix">
    ...
    <div class="viscol col20 bg-ldgray">
      ...
      <div class="vismenurow bmar-tiny">
        ...
        <!-- <output class="bubbleOpacity"></output> -->
      </div>
      <div class="vismenurow bmar-tiny">
        <label class="label">Bandwith slider</label>
      </div>
      <div class="vismenurow bmar-tiny">
        <input type="range" min="0" max="20" value="10" class="range full-width" id="bandwidthContour">
        <!-- <output class="bubbleBandwidth"></output> -->
      </div>
      <div class="vismenurow bmar-tiny">
